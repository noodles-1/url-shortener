        ...
        <>
            <Form {...form}>
                <form onSubmit={form.handleSubmit(data => onSubmit(data, resetField, setLoading))} className="grid grid-rows-2 gap-2 items-start">
                    <section className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 items-start">
                        <FormField
                            control={form.control}
                            name="link"
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input 
                                            className="text-gray-300 text-[12px] md:text-[14px]"
                    ...
                    <section className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
                        ...
                        {!urlData && <>
                            {!loading ?
                                <Button type="submit" className="bg-[#37439e] hover:bg-[#313761] hover:cursor-pointer mt-[26px] text-gray-200 text-[12px] md:text-[14px]"> 
                                    Generate URL 
                                </Button>
                            :
                                <Button disabled className="bg-[#37439e] mt-[26px] text-gray-200 text-[12px] md:text-[14px]"> 
                    ...
                    {linkValue &&
                        <p className="text-gray-300 text-[12px] md:text-sm mt-1"> 
